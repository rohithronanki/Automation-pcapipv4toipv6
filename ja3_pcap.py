...
def process_pcap(pcap, any_port=False):
    ...
    for timestamp, buf in pcap:
        ...
        if not (tcp.dport == SSL_PORT or tcp.sport == SSL_PORT or any_port):
            print("Doesn't match SSL port or we are picky")
            continue
        if len(tcp.data) <= 0:
            continue
        ...
        if len(records) <= 0:
            print("Length of record is zer0")
            continue
    ...
    with open(args.pcap, 'rb') as fp:
        try:
            ...
            try:
                ...
                print("File doesn't appear to be a PCAP or PCAPng")
                raise Exception(
                        "File doesn't appear to be a PCAP or PCAPng: %s, %s" %
                        (e_pcap, e_pcapng))
        print("No exe while reading")
...
# TLS Version: 0303 (1.2)
# Cipher Suites: C02F-002F-C030 (Note the hyphens separating cipher suites)
# Extensions: 0000-0010-000B
# Elliptic Curves: 0017-0018
# Elliptic Curve Formats: 00
...
# 0303,C02F-002F-C030,0000-0010-000B,0017-0018,00
# TLS Version: 0303 (1.2)
# Cipher Suites: C02F-002F-C030 (Note the hyphens separating cipher suites)
# Extensions: 0000-0010-000B
# Elliptic Curves: 0017-0018
...
##https://blog.cloudflare.com/ru-ru/ja4-signals/


#C:\Users\RohithRonanki\AppData\Roaming\JetBrains\PyCharmCE2022.3\scratches> python ja3_pcap.py -a  C:\Users\RohithRonanki\Downloads\tls12.pcap

#C:\Users\RohithRonanki\PycharmProjects\testing> ja3 --json C:\Users\RohithRonanki\Downloads\tls12.pcap

#C:\Users\RohithRonanki\PycharmProjects\testing> python c:\Users\RohithRonanki\Downloads\ja3s.py -a  C:\Users\RohithRonanki\Downloads\tls12.pcap
